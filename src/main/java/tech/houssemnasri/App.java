...
import tech.houssemnasri.impl.pathfinder.player.SimpleVisualizer;
...
public class App extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    PNode node = new PNode(new Position(2, 3), INode.Type.SOURCE);
    ...
    Visualizer algorithmPlayer = new SimpleVisualizer(new AStarAlgorithm(grid, true));
